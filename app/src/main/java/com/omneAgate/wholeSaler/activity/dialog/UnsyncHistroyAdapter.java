 ...
 */
public class UnsyncHistroyAdapter extends BaseAdapter {
    ...
    public UnsyncHistroyAdapter(Context context ,List<WholesalerPostingDto> keroseneStockOutwardList){
        this.context=context;
        this.keroseneStockOutwardList=keroseneStockOutwardList;
        Log.e("UnsyncAdapter","size of the list"+keroseneStockOutwardList.size());
        ...
        try{
          ...
          //     view.setMinimumHeight(50);
            ...
            holder.quantity.setText(""+format.format(wholesalerpostingdata.getQuantity()));
              Log.e("UnsyncHistroyadapter","get status "+wholesalerpostingdata.getStatus());
